          ...
          <div className="flex gap-4 items-center">
            ...
            <div className="text-app">
              <div>
                ...
                <p className="text-[14px] md:text-sm font-Roboto font-normal lowercase hidden md:block ">{app.description}</p>
              </div>
            </div>
          </div>
          <p className="text-[14px] md:text-sm font-Roboto font-normal lowercase block md:hidden">{app.description}</p>
          <div className="bottom flex justify-between mt-2">
            <select name="select" className="bg-black text-white font-Roboto font-bold text-[12px] md:px-2 pr-6 md:pr-14 py-1 rounded-sm">
